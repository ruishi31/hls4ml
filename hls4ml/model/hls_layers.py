...
class Dense(Layer):
    def initialize(self):
        ...
        if self.model.config.is_resource_strategy(self):
            if self.model.config.backend.name == 'Vivado' or self.model.config.backend.name == 'Catapult':
...
class Conv2DBatchnorm(Conv2D):
    ...
    def initialize(self):
        ...
        if self.model.config.is_resource_strategy(self) and (self.model.config.backend.name == 'Vivado' or self.model.config.backend.name == 'Catapult'):
